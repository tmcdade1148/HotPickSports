...
// Slim top header for the Home Screen. Replaces what was previously
// removed during the redesign per spec §6.4.2.
//
// Reference (May 13 2026 v2):
//   HOTPICK SPORTS                            [ NFL · W08 ]
//
// Left  — HotPick wordmark: "HOT" + "PICK" + " SPORTS" (small caps)
//         "HOT" and "SPORTS" in primary flame; "PICK" in textPrimary
// Right — period pill: e.g. "NFL · W08" (or "NFL · PRESEASON")
//         primary-bordered pill, primary text
